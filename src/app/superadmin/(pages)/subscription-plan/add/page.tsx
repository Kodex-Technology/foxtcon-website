...
const AddSubscriptionPage = () => {
    ...
    if (planType) {
      ...
      if (storedData) {
        ...
        setAllFeaturesSelected(
          (parsedData.features || []).length === featuresList.length,
        );
      } else {
        setFormData((prev) => ({
          ...prev,
  ...
  const handlePublish = () => {
    const rulesToUse: Partial<typeof subscriptionRules> = {
      ...subscriptionRules,
    };
    ...
    if (Object.keys(validationErrors).length === 0) {
      const storageKey = formData.subscription_name
        .toLowerCase()
        .replace(/\s+/g, "_");
              ...
              <div className="form-field">
                <div className="input-field">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("subscription_name", e.target.value)
                    }
              ...
              <div className="form-field">
                <div className="input-field">
                  <select
                    ...
                    onChange={(e) =>
                      handleInputChange("subscription_duration", e.target.value)
                    }
              ...
              <div className="form-field">
                <div className="input-field">
                  <textarea
                    ...
                    className={
                      formData.subscription_description ? "filled" : ""
                    }
                  />
        ...
        <div className="form-wrapper">
          <div className="feature-header">
            <h2>
              Select feature
              <span>
                Pick the features you want to offer as part of this subscription
                plan...
              </span>
            </h2>
