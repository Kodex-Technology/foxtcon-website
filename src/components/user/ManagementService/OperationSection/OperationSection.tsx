    ...
    <div className="container">
      <div className="operation-wrapper">
        <div className="common-heading">
          ...
          <p>
            The success of your hotel is contingent upon the seamless
            integration of operations, from guest services to financial
            management. At Crescent, our hotel management and operations
            programs are time-tested and proactive to adapt to external shifts
            ...
            <div className="operation-card">
              <div className="content-layer">
                ...
                <p>
                  ...
                  ensuring efficient financial operations through our
