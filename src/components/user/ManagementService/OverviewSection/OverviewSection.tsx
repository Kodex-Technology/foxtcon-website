  ...
  return (
    <div className="overview-wrapper">
      <div className="common-heading">
        ...
        <p>
          Foxtcon Hotels & Resorts is built on a results-driven paradigm with
          hands-on experts across the hospitality industry. As entrepreneurs and
          operators at heart, we have a deep understanding of developing,
          operating and renovating our properties.
        </p>
      </div>
      <div className="row">
