...
const GlobalConnectionSection = () => {
  return (
    <div className="container-fluid global-connection-fluid">
          ...
          <div className="content-col">
            <div className="common-heading">
              ...
              <p>
                ...
                precision SEO to data-driven online campaigns, dynamic social
                media engagement, and seamless CRM integration. Our strategic
                approach is designed to elevate brand visibility, deepen
                customer engagement, and accelerate long-term business growth
