...
const CoreValueSection = () => {
  ...
  return (
    <div className="container-fluid px-0 core-value-fluid">
                ...
                <div className="core-content-header">
                  <div className="description">
                    <p>
                      ...
                      company built by hoteliers, not just businesspeople. We
                      are operators at heart — hands-on leaders with deep
                      industry roots, driven by a passion for operational
                      excellence and sustainable growth. At Foxtcon, we go
                      beyond traditional management by offering customized
                      strategies, cutting-edge technology integration, and a
                      relentless commitment to performance.From boutique hotels
                      to full-service resorts and restaurants, we empower
                      hospitality businesses to unlock their full potential —
                      optimizing the guest journey, capturing new markets, and
